...
export class FavoritesView extends Favorites {
  constructor(root) {
    super(root);
    this.tbody = this.root.querySelector("table tbody");//a definição do tbody deve vir antes do update
    this.update();
    this.onadd();
  }
  ...
  createRow() {
    ...
    tr.innerHTML = `  
      <td class="user">
          <img src="https://github.com/marco-d-sousa.png" alt="" />
          <a href="https://github.com/marco-d-sousa" target="_blank">
          <p>Marco de Sousa</p>
          <span>Marco-D-Sousa</span>
          </a>
      </td>
